...
let prideAndPrejudice = new Novel ('Pride and Prejudice', 'Jane Auston', 1813, 1111111111111, 432, 32, 'No');
...
console.log(shuttleBuildingManual.discarded, prideAndPrejudice.discarded);